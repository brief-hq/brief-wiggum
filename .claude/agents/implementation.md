...
5. Call brief ask --mode check before architectural changes
6. Pause at permission gates (commit, push, destructive ops)

Tools: All coding tools, Brief CLI (read + brief ask --mode check), TodoWrite (status updates)
...
- ALWAYS call brief ask --mode check before architectural decisions
